...
baseImageMascara.src = "./mascarafoto.png?v=2";
...
function drawArte() {
  ...
  if (optionMenu() === "figura" && content) {
    context.translate(1080 / 2, 345);
    context.rotate((-2 * Math.PI) / 180);

    context.textBaseline = "middle";
    context.font = "100px myPantonFont";

    const width = context.measureText(content).width;

    context.fillStyle = "#fff";
    roundRect(context, -width / 2 - 45, -160 / 2, width + 45 * 2, 160, 21.66);

    context.fillStyle = "#145f12";
